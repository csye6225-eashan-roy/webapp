...
sudo su - postgres -c "psql -U postgres -c \"CREATE USER \\\"db-user\\\" WITH PASSWORD '@ccess4d-b';\""
sudo su - postgres -c "psql -U postgres -c \"CREATE DATABASE users;\""
sudo su - postgres -c "psql -U postgres -c \"ALTER DATABASE users OWNER TO \\\"db-user\\\";\""
